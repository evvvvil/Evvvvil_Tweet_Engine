...
namespace VVVV.Nodes.Network
{
    ...
    public class EvvvvilTweetSearch : IPluginEvaluate
	{
        ...
        public ITweetSearchParameters GetTwitterSearchParameters()
        {
            ...
            var searchParameter = Search.GenerateSearchTweetParameter(searchFor);
            ...
            if (!untile.Contains(0))
            {
                if (untile.Length > 2)
                {
                    ...
                    catch (System.ArgumentOutOfRangeException e)
                    {
                        ...
                        FLogger.Log(LogType.Debug, "Until date badly formated");
            ...
            if (!sincee.Contains(0))
            {
                if (sincee.Length > 2)
                {
                    ...
                    catch (System.ArgumentOutOfRangeException e)
                    {
                        ...
                        FLogger.Log(LogType.Debug, "Since date badly formated");
                        //throw new System.ArgumentOutOfRangeException("Date badly formated", e);
                    }
                }
                else
        ...
        public void Evaluate(int SpreadMax)
		{
            ...
            if(foundNewTweets){
                ...
                totalNumOfTweets =  listTweetText.Count;
